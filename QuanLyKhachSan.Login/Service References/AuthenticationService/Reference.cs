...
// 
namespace QuanLyKhachSan.Login.AuthenticationService {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface AuthenticationServiceChannel : QuanLyKhachSan.Login.AuthenticationService.AuthenticationService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AuthenticationServiceClient : System.ServiceModel.ClientBase<QuanLyKhachSan.Login.AuthenticationService.AuthenticationService>, QuanLyKhachSan.Login.AuthenticationService.AuthenticationService {
        ...
        System.IAsyncResult QuanLyKhachSan.Login.AuthenticationService.AuthenticationService.BeginValidateUser(string username, string password, string customCredential, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginValidateUser(username, password, customCredential, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool QuanLyKhachSan.Login.AuthenticationService.AuthenticationService.EndValidateUser(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginValidateUser(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((QuanLyKhachSan.Login.AuthenticationService.AuthenticationService)(this)).BeginValidateUser(username, password, customCredential, callback, asyncState);
        }
        
        private object[] OnEndValidateUser(System.IAsyncResult result) {
            bool retVal = ((QuanLyKhachSan.Login.AuthenticationService.AuthenticationService)(this)).EndValidateUser(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult QuanLyKhachSan.Login.AuthenticationService.AuthenticationService.BeginLogin(string username, string password, string customCredential, bool isPersistent, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginLogin(username, password, customCredential, isPersistent, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool QuanLyKhachSan.Login.AuthenticationService.AuthenticationService.EndLogin(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginLogin(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((QuanLyKhachSan.Login.AuthenticationService.AuthenticationService)(this)).BeginLogin(username, password, customCredential, isPersistent, callback, asyncState);
        }
        
        private object[] OnEndLogin(System.IAsyncResult result) {
            bool retVal = ((QuanLyKhachSan.Login.AuthenticationService.AuthenticationService)(this)).EndLogin(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult QuanLyKhachSan.Login.AuthenticationService.AuthenticationService.BeginIsLoggedIn(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginIsLoggedIn(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool QuanLyKhachSan.Login.AuthenticationService.AuthenticationService.EndIsLoggedIn(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginIsLoggedIn(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((QuanLyKhachSan.Login.AuthenticationService.AuthenticationService)(this)).BeginIsLoggedIn(callback, asyncState);
        }
        
        private object[] OnEndIsLoggedIn(System.IAsyncResult result) {
            bool retVal = ((QuanLyKhachSan.Login.AuthenticationService.AuthenticationService)(this)).EndIsLoggedIn(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult QuanLyKhachSan.Login.AuthenticationService.AuthenticationService.BeginLogout(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginLogout(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void QuanLyKhachSan.Login.AuthenticationService.AuthenticationService.EndLogout(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginLogout(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((QuanLyKhachSan.Login.AuthenticationService.AuthenticationService)(this)).BeginLogout(callback, asyncState);
        }
        
        private object[] OnEndLogout(System.IAsyncResult result) {
            ((QuanLyKhachSan.Login.AuthenticationService.AuthenticationService)(this)).EndLogout(result);
            return null;
        }
        ...
        protected override QuanLyKhachSan.Login.AuthenticationService.AuthenticationService CreateChannel() {
            return new AuthenticationServiceClientChannel(this);
        }
        
        private class AuthenticationServiceClientChannel : ChannelBase<QuanLyKhachSan.Login.AuthenticationService.AuthenticationService>, QuanLyKhachSan.Login.AuthenticationService.AuthenticationService {
            
            public AuthenticationServiceClientChannel(System.ServiceModel.ClientBase<QuanLyKhachSan.Login.AuthenticationService.AuthenticationService> client) : 
                    base(client) {
            }

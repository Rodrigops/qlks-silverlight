...
// 
namespace QuanLyKhachSan.AuthenticationService {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface AuthenticationServiceChannel : QuanLyKhachSan.AuthenticationService.AuthenticationService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AuthenticationServiceClient : System.ServiceModel.ClientBase<QuanLyKhachSan.AuthenticationService.AuthenticationService>, QuanLyKhachSan.AuthenticationService.AuthenticationService {
        ...
        System.IAsyncResult QuanLyKhachSan.AuthenticationService.AuthenticationService.BeginValidateUser(string username, string password, string customCredential, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginValidateUser(username, password, customCredential, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool QuanLyKhachSan.AuthenticationService.AuthenticationService.EndValidateUser(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginValidateUser(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((QuanLyKhachSan.AuthenticationService.AuthenticationService)(this)).BeginValidateUser(username, password, customCredential, callback, asyncState);
        }
        
        private object[] OnEndValidateUser(System.IAsyncResult result) {
            bool retVal = ((QuanLyKhachSan.AuthenticationService.AuthenticationService)(this)).EndValidateUser(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult QuanLyKhachSan.AuthenticationService.AuthenticationService.BeginLogin(string username, string password, string customCredential, bool isPersistent, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginLogin(username, password, customCredential, isPersistent, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool QuanLyKhachSan.AuthenticationService.AuthenticationService.EndLogin(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginLogin(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((QuanLyKhachSan.AuthenticationService.AuthenticationService)(this)).BeginLogin(username, password, customCredential, isPersistent, callback, asyncState);
        }
        
        private object[] OnEndLogin(System.IAsyncResult result) {
            bool retVal = ((QuanLyKhachSan.AuthenticationService.AuthenticationService)(this)).EndLogin(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult QuanLyKhachSan.AuthenticationService.AuthenticationService.BeginIsLoggedIn(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginIsLoggedIn(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool QuanLyKhachSan.AuthenticationService.AuthenticationService.EndIsLoggedIn(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginIsLoggedIn(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((QuanLyKhachSan.AuthenticationService.AuthenticationService)(this)).BeginIsLoggedIn(callback, asyncState);
        }
        
        private object[] OnEndIsLoggedIn(System.IAsyncResult result) {
            bool retVal = ((QuanLyKhachSan.AuthenticationService.AuthenticationService)(this)).EndIsLoggedIn(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult QuanLyKhachSan.AuthenticationService.AuthenticationService.BeginLogout(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginLogout(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void QuanLyKhachSan.AuthenticationService.AuthenticationService.EndLogout(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginLogout(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((QuanLyKhachSan.AuthenticationService.AuthenticationService)(this)).BeginLogout(callback, asyncState);
        }
        
        private object[] OnEndLogout(System.IAsyncResult result) {
            ((QuanLyKhachSan.AuthenticationService.AuthenticationService)(this)).EndLogout(result);
            return null;
        }
        ...
        protected override QuanLyKhachSan.AuthenticationService.AuthenticationService CreateChannel() {
            return new AuthenticationServiceClientChannel(this);
        }
        
        private class AuthenticationServiceClientChannel : ChannelBase<QuanLyKhachSan.AuthenticationService.AuthenticationService>, QuanLyKhachSan.AuthenticationService.AuthenticationService {
            
            public AuthenticationServiceClientChannel(System.ServiceModel.ClientBase<QuanLyKhachSan.AuthenticationService.AuthenticationService> client) : 
                    base(client) {
            }

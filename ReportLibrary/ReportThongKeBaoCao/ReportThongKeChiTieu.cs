namespace Telerik.Reporting
{
    ...
    /// <summary>
    /// Summary description for ReportThongKeChiTieu.
    /// </summary>
    public partial class ReportThongKeChiTieu : Telerik.Reporting.Report
    {
        public ReportThongKeChiTieu()
        {
            //
        ...
        private void Report_NeedDataSource(object sender, System.EventArgs e)
        {
            ...
            if (_Type == "1")
            {
                ...
                sqlDataSource.SelectCommand = "dbo.sp_PhieuNhapKho_GetItems_TheoNgay";
                this.sqlDataSource.Parameters.AddRange(new Telerik.Reporting.SqlDataSourceParameter[] 
                {
                    new Telerik.Reporting.SqlDataSourceParameter("@NgayNhapSo", System.Data.DbType.Int32, int.Parse(_Ngay))
                });
            }
            else if (_Type == "2")
            {
                txtNgay.Value = "Tháng   " + _Thang + "   Năm   " + _Nam;
                sqlDataSource.SelectCommand = "dbo.sp_PhieuNhapKho_GetItems_TheoThang";
                this.sqlDataSource.Parameters.AddRange(new Telerik.Reporting.SqlDataSourceParameter[] 
                {
                    new Telerik.Reporting.SqlDataSourceParameter("@ThangNhap", System.Data.DbType.Int32, int.Parse(_Thang)),
                    new Telerik.Reporting.SqlDataSourceParameter("@NamNhap", System.Data.DbType.Int32, int.Parse(_Nam))
                });
            }
            else if (_Type == "3")
            {
                txtNgay.Value = "Năm:  " + _Nam;
                sqlDataSource.SelectCommand = "dbo.sp_PhieuNhapKho_GetItems_TheoNam";
                this.sqlDataSource.Parameters.AddRange(new Telerik.Reporting.SqlDataSourceParameter[] 
                {
                    new Telerik.Reporting.SqlDataSourceParameter("@NamNhap", System.Data.DbType.Int32, int.Parse(_Nam))
                });
            ...
            else if (_Type == "4")
            {
                ...
                sqlDataSource.SelectCommand = "dbo.sp_PhieuNhapKho_GetItems_TuNgayDenNgay";
